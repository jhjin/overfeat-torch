...
wget https://raw.githubusercontent.com/sermanet/OverFeat/master/download_weights.py --no-check-certificate

# download a sample image from OverFeat repository
wget https://raw.githubusercontent.com/sermanet/OverFeat/master/samples/bee.jpg --no-check-certificate
